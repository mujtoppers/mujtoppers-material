...
const years = [
  {
    ...
    resources: [
      { label: "PYQs", href: "https://drive.google.com/drive/folders/1-YTYGnrbEbrorAaUtxcI2K-do_dZSItl?usp=drive_link" },
      ...
      <main className="mx-auto flex w-full max-w-6xl flex-col gap-16 px-4 sm:px-6 lg:px-0">
        <section className="flex flex-col gap-5 text-center mx-auto lg:max-w-3xl">
          <h1 className="text-4xl font-semibold leading-tight tracking-tight sm:text-5xl">
            ...
            {" "}
            <span className="animate-word-2 inline-block text-gradient-orange-underline">DSE</span>
            {" "}
